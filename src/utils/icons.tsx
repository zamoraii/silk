 ...
 * Designed to be easily replaceable with a library (Lucide, Heroicons, etc.)
 * All icons are 18x18 with currentColor fill.
 */
...
export function IconListUnordered(props: IconProps) {
  return (
    <Svg {...props}>
